...
export function Hero() {
  ...
  return (
    <section id="hero" ref={containerRef} className="relative h-screen w-full overflow-hidden">
      ...
      {/* Typography Overlay */}
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 md:px-15 md:py-20">
        {/* Top Left */}
        <motion.div
        ...
        >
          <p className="font-mono text-xs tracking-[0.3em] text-muted-foreground mb-2">01 — HERO</p>
          <h2 className="font-sans text-4xl md:text-6xl lg:text-9xl font-light tracking-tight text-balance">
            JAMES
            <br />
            <span className="italic">JIMENEZ</span>
          </h2>
        </motion.div>
        ...
        >
          ...
          >
            Initialize
            <span className="absolute -top-1 -right-1 w-2 h-2 bg-[#d6d6d1] rounded-full animate-pulse" />
          </motion.button>
        </motion.div>
        ...
        >
          <h2 className="font-sans text-4xl md:text-6xl lg:text-7xl font-light tracking-tight text-balance">
            FULL-STACK
            <br />
            <span className="italic">AI/ML ENGINEER</span>
          </h2>
        </motion.div>
      </motion.div>
